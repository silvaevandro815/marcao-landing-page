          ...
          <div className="grid md:grid-cols-2 gap-10 items-start pt-4">
            ...
            <div className="flex flex-col gap-6">
              ...
              <a
                ...
                className="btn-shimmer group flex items-center justify-center gap-2.5 px-4 py-4 sm:px-8 sm:py-5 rounded-2xl bg-brand-lime text-black font-black text-sm sm:text-base hover:shadow-lime-glow transition-all duration-300 hover:scale-105 active:scale-95 animate-glow-pulse w-full text-center"
              >
                ...
                <span className="truncate">Assinar Agora — R$ 49,90/mês</span>
              </a>
