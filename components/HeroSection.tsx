...
export default function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Orbs */}
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-brand-lime/5 rounded-full blur-3xl animate-aurora" />
      <div className="absolute bottom-1/3 right-1/4 w-80 h-80 bg-brand-orange/5 rounded-full blur-3xl animate-aurora" style={{ animationDelay: "4s" }} />
